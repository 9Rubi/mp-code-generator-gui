package ink.rubi.codegenerator.json;
...
//            writeArrayField(value, gen, serializers);
   ...
   /* public static void main(String[] args) throws Exception {
        ConfigHolderContainer container = MainController.getObjectMapper()
                .readValue(new File("C:\\Users\\13447\\Desktop\\config.json"), ConfigHolderContainer.class);
